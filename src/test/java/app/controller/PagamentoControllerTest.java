...
public class PagamentoControllerTest {
    ...
    void setup() {
        ...
        formaPagamento.setNome("Cartão de Crédito");
    ...
    void testSave() {
        Pagamento pagamento = new Pagamento();
        ResponseEntity<String> response = controller.save(pagamento);
    ...
    void testUpdate() {
        Pagamento pagamento = new Pagamento();
        ResponseEntity<String> response = controller.update(pagamento, 1L);
    ...
    void testFindById() {
        ...
        assertEquals(1L, obj.getIdPagamento());
    }
